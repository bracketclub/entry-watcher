...
function Entry(options, cb) {
    ...
    _.defaults(options, {
        ...
        locks: new Locks({year: options.year, sport: options.sport, dateFormat: ENTRY_TYPES[this.type].dateFormat})
    });

    _.extend(this, _.pick(options, 'logger', 'finder', 'save', 'locks'));
